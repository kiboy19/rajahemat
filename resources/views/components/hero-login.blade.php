    ...
    <div class="container mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
        <div class="flex flex-col lg:flex-row items-center bg-red-900 overflow-hidden space-y-6 lg:space-y-0 lg:space-x-6">
            ...
            <div class="lg:w-1/2 p-8 text-white text-center flex flex-col justify-center">
                ...
                <a href="/register" class="bg-green-600 text-white font-bold py-3 px-6 rounded-md hover:bg-gray-200 hover:text-black transition">
                    Sign Up Now
                </a>
            </div>
            <!-- Right Column -->
                ...
                <div class="bg-red-900 border border-red-900 rounded-[20px] shadow-[0px_4px_20px_rgba(0,0,0,0.50)] p-6">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="email" class="w-full p-3 border rounded-md focus:ring focus:ring-blue-300" placeholder="Enter your email" name="email" value="{{ old('email') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="password" class="w-full p-3 border rounded-md focus:ring focus:ring-blue-300" placeholder="Enter your password" name='password' required>
                        </div>
                        <!-- Forgot Password -->
