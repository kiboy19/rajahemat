<x-admin-layout>
    ...
    <div class="flex-1 p-4 md:p-6 ml-0 md:ml-64 transition-all">
        ...
        <div class="flex justify-between items-center mb-6 md:hidden">
            <h1 class="text-xl font-bold">Tambah Layanan</h1>
            <button id="hamburger"
        ...
        <div class="bg-white p-4 md:p-6 rounded shadow">
            <h2 class="text-xl font-bold mb-6">Tambah Layanan Baru</h2>
            ...
            <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="id" id="id"
                        class="w-full border border-gray-300 rounded p-2" placeholder="Masukkan ID Layanan" required />
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name"
                        class="w-full border border-gray-300 rounded p-2" placeholder="Masukkan Nama Layanan"
                        required />
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price"
                        class="w-full border border-gray-300 rounded p-2" placeholder="Masukkan Harga" required />
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="min" id="min"
                        class="w-full border border-gray-300 rounded p-2" placeholder="Masukkan Minimum Order"
                        required />
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max" id="max"
                        class="w-full border border-gray-300 rounded p-2" placeholder="Masukkan Maximum Order"
                        required />
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" class="w-full border border-gray-300 rounded p-2"
